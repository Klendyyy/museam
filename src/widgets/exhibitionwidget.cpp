...
void ExhibitionWidget::setupUi()
{
    ...
    m_manageExhibitsButton->setMinimumWidth(150);
    ...
    m_tableView->hideColumn(ExhibitionModel::CreatedAt);
    m_tableView->hideColumn(ExhibitionModel::UpdatedAt);
...
void ExhibitionWidget::onManageExhibitsClicked()
{
    ...
    // Здесь можно открыть диалог управления экспонатами выставки
